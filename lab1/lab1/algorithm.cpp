...
/* Алгоритм решения
   ...
   [x] 1) Убедиться в том, что в каждом множестве есть по крайней мере три точки
   [x] 2) Убедиться в том, что в каждом множестве есть тройка равноудалённых
   точек

   [x] 3) Найти первую (по порядку) тройку равноудалённых точек из первого
   множества [x] 4) Найти первую (по порядку) тройку равноудалённых точек из
   второго множества

   [x] 5) Найти координаты центра окружности, проходящей через тройку точек из
   первого множества
   [x] 6) Найти координаты центра окружности, проходящей через тройку точек из
   второго множества

   [x] 7) Для каждой точки на окружностях, найти диаметрально противоположную ей

   [x] 8) Отсортировать точки в полученных шестиугольниках

   [x] 9) Найти область пересечения двух шестиугольников (которая будет выпуклым
   многоугольником)

   [x] 10) Удалить дубликаты точек из полученного многоугольника-пересечения

   [x] 11) Найти какую-нибудь точку внутри полученного многоугольника (берём
   центр масс так как многоугольник выпуклый, и ц. м. точно будет внутри)

   [x] 12) Отсортировать точки в многоугольнике (против/по) часовой стрелке
   относительно центра масс

   [x] 13) Найти площадь многоугольника, суммируя площади составляющих его
   треугольников
*/
